...
//  private static final int DISPLAY_MAX = 6000;
  ...
  private ChartPanel buildDialPlot(int minimumValue, int maximumValue,
    ...
    StandardDialScale scale = new StandardDialScale(-0D, 400D, -110D, -320D, 50D, 4);
    ...
    StandardDialScale standarddialscale1 = new StandardDialScale(-0D, 400D, -110D, -320D, 50D, 4);
