...
//  private static final int DISPLAY_MAX = 6000;
  ...
  private ChartPanel buildDialPlot(int minimumValue, int maximumValue,
    ...
    DialTextAnnotation dialtextannotation = new DialTextAnnotation("Deg C");
    ...
    StandardDialScale scale = new StandardDialScale(-20D, 120D, -110D, -320D, 10D, 1);
    ...
    StandardDialScale standarddialscale1 = new StandardDialScale(-20D, 120D, -110D, -320D, 10D, 1);
    ...
    JFreeChart jfreechart = new JFreeChart(plot);
                        jfreechart.setTitle("Motor & Invertor Temp");
