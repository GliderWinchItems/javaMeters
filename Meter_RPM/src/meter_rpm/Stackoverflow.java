...
//  private static final int DISPLAY_MAX = 6000;
  ...
  private ChartPanel buildDialPlot(int minimumValue, int maximumValue,
    ...
    StandardDialScale scale = new StandardDialScale(-12000D, 12000D, -110D, -320D, 2000D, 4);
    ...
    StandardDialScale standarddialscale1 = new StandardDialScale(-12000D, 12000D, -110D, -320D, 2000D, 4);
    ...
    JFreeChart jfreechart = new JFreeChart(plot);
                        jfreechart.setTitle("RPM: CMD and REPORTED");
