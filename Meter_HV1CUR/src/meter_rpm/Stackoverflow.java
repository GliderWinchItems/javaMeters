...
frame.setLocation(0, 0);
  ...
  private ChartPanel buildDialPlot(int minimumValue, int maximumValue,
    ...
    DialTextAnnotation dialtextannotation = new DialTextAnnotation("amps");
    ...
    StandardDialScale scale = new StandardDialScale(-100D, 300D, -110D, -310D, 50D, 4);
    ...
    StandardDialScale standarddialscale1 = new StandardDialScale(200D, 400D, -110D, -320D, 50D, 4);
    ...
    JFreeChart jfreechart = new JFreeChart(plot);
                        jfreechart.setTitle("BATT VOLTS:CURRENT");
